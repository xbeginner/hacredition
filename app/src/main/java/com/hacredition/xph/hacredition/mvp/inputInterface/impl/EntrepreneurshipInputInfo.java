...
public class EntrepreneurshipInputInfo implements InputInfoInterface {

    private Entrepreneurship entrepreneurship;

    public EntrepreneurshipInputInfo(Entrepreneurship entrepreneurship){
    ...
    public void save(final SaveCallback saveCallback) {
        ...
        manager.saveEntrepreneurship(entrepreneurship)
