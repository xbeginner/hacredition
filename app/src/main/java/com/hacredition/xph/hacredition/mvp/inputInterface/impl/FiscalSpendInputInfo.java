...
public class FiscalSpendInputInfo implements InputInfoInterface {

    private FiscalSpend fiscalSpend;

    public FiscalSpendInputInfo(FiscalSpend fiscalSpend){
          this.fiscalSpend = fiscalSpend;
    }
    ...
    public void save(final SaveCallback saveCallback) {
        ...
        manager.saveFiscalSpend(fiscalSpend)
