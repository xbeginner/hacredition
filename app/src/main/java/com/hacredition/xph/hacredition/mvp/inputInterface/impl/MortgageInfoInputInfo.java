...
public class MortgageInfoInputInfo implements InputInfoInterface {

    private MortgageInfo mortgageInfo;

    public MortgageInfoInputInfo(MortgageInfo mortgageInfo){
    ...
    public void save(final SaveCallback saveCallback) {
        ...
        manager.saveMortgageInfo(mortgageInfo)
