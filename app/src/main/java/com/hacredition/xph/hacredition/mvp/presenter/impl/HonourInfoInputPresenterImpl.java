...
import com.hacredition.xph.hacredition.mvp.inputInterface.impl.HonourInfoInputInfo;
...
public class HonourInfoInputPresenterImpl extends BasePresenterImpl<InputInfoView<HonourInfo>,HonourInfo>
            implements InputInfoPresenter<HonourInfo>,SaveCallback{

    private InputInfoInteractorImpl mInputInfoImpl;

    @Inject
    public HonourInfoInputPresenterImpl(InputInfoInteractorImpl inputInfoImpl){
            this.mInputInfoImpl = inputInfoImpl;
    }

    @Override
    public void saveInputInfo(HonourInfo HonourInfo) {
        HonourInfoInputInfo info = new HonourInfoInputInfo(HonourInfo);
