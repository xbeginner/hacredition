...
public class RetrofitManager {
    ...
    private static final String BASE_URL = "localhost:8081/hacredition/";
    ...
    public Observable<Map<String, List<NewsSummary>>> getNewsListObservable(int existNewsId) {
        return mNewsService.getNewsList(getCacheControl(),existNewsId);
    }
